...
Deno.serve(async req => {
  ...
  try {
    ...
    if(body.action === "geocode"){
      ...
      await client.rpc("record_usage_event",{p_category:"maps",p_cost:0.005,p_metadata:{action:"geocode"}});
    ...
    if(body.action === "nearby"){
      ...
      await client.rpc("record_usage_event",{p_category:"maps",p_cost:0.01,p_metadata:{action:"nearby"}});
