...
test('browser never contains a Google Maps key field or direct Google API call', () => { const html=read('netlify-site/index.html'); assert.doesNotMatch(html,/maps_api_key|mapsKeyInput|maps\.googleapis\.com|places\.googleapis\.com/); assert.match(html,/functions\.invoke\('maps-proxy'/); });
